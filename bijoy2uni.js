...
module.exports.ConvertToUnicode = function ConvertToUnicode(ConvertFrom, line) {	
...
module.exports.IsAscii = function IsAscii(str){
	return /[\w\d]+/.test(str)
}